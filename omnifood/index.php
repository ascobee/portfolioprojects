        ...
        <section class="section-steps" id="works">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2 steps-box">
                    ...
                    <a href="#" class="btn-app"><img src="Resources/img/download-on-app.png" alt="App Store Button"></a>
                    <a href="#" class="btn-app android-app"><img src="Resources/img/download-app-android.png" alt="Play Store Button"></a>
                </div>
            </div>
                    ...
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                ...
                                <li><i class="icon ion-ios-close icon-small"></i>Access to newest creations</li>
                                <li><i class="icon ion-ios-checkmark icon-small"></i>Free delivery</li>
                            </ul>
                        </div>
